...
\(\operatorname{pmf}_{M}, *_{\text {param }}\}\)
    forwardTree \(\left.\left.\left.+\left[\operatorname{pmf}_{X_{1}}, \operatorname{pmf}_{X_{2}}, \ldots \operatorname{pmf}_{X_{n}}\right]\right]\right)\)
...
\(*_{\text {param }}\) operator
        ...
        reverseTree \(\left.\left.+\left[\operatorname{pmf}_{M}\right]\right]\right.\)
        for \(i=1\) to len \(\left(\log _{2}(n)\right), i+=1\) do
...
29: end for
30: reverseTree.append(newLayer \(\mathbf{3}\)
31: end for
