...
with $a_{0}=1$ [73]. The number of DAGs increases explosively, as the first few steps in the recursion show: $1,1,3$, 25, 543, 29 281, 3781 503, 1138779 265. That means, we must use heuristic strategies to find high-scoring Bayesian networks without enumerating all possible DAGs.
