...
$$
\mathrm{p}\left(\boldsymbol{z}_{n} \mid \mathrm{r} . \mathrm{v}\right) \propto \mathrm{p}\left(\boldsymbol{z}_{n} \mid \mathrm{pa}\left(\boldsymbol{z}_{n}\right)\right) \cdot \prod_{\boldsymbol{z}_{m} \in \mathrm{ch}\left(\boldsymbol{z}_{n}\right)} \mathrm{p}\left(\boldsymbol{z}_{m} \mid \mathrm{pa}\left(\boldsymbol{z}_{m}\right)\right)
$$
