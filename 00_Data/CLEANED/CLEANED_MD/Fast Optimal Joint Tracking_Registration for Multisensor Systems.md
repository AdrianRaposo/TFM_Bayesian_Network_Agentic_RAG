...
[^1]
[^0]:    ${ }^{3}$ The least-squares $\|R s-z\|^{2}$ is invariant under an orthogonal transformation $T$, i.e., $\|T(R s-z)\|^{2}=(R s-z)^{t} T^{t} T(R s-z)=(R s-z)^{t}(R s-$ $z)=\|R s-z\|^{2}$.
...
Proof: $R_{\rho}^{-1}=\left[\begin{array}{cc}R_{\rho_{11}}^{-1} & -R_{\rho_{11}}^{-1} R_{\rho_{12}} R_{\rho_{22}}^{-1} \\ 0 & R_{\rho_{22}}^{-1}\end{array}\right]$. Thus the mean

$$
\begin{aligned}
\mu_{\rho} & =R_{\rho}^{-1} z_{\rho} \\
& =\left[\begin{array}{cc}
R_{\rho_{11}}^{-1} & -R_{\rho_{11}}^{-1} R_{\rho_{12}} R_{\rho_{22}}^{-1} \\
0 & R_{\rho_{22}}^{-1}
\end{array}\right]\left[\begin{array}{c}
z_{1} \\
z_{2}
\end{array}\right] \\
& =\left[\begin{array}{cc}
R_{\rho_{11}}^{-1} z_{\rho_{1}} & -R_{\rho_{11}}^{-1} R_{\rho_{12}} R_{\rho_{22}}^{-1} z_{2} \\
