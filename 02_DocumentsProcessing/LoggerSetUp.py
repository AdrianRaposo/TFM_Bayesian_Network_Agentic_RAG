'''
LoggerSetUp.py
This module sets up a logger for the DocumentsOCR application.
It configures two handlers: one for general logs and another specifically for errors.   

This allows for better separation of log messages, making it easier to debug and monitor the application.
'''
import logging
import os
